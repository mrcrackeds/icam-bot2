...
Contoh : *${prefix}tiktokstalk @unknown*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}igstalk @cracked_212*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}smulestalk @unknown*
...
Contoh : *${prefix}googlesearch siapa itu Icam*
...
exports.info = info()
function snk() {
    return `Syarat dan Ketentuan Bot *ICAM*
